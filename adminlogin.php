...
if (isset($_POST["LogIn"])) {
  ...
  if (mysqli_num_rows($check_email) > 0) {
    ...
    header("Location: emart-admin-panel.php");
  } else {
...
<body>
  ...
  <div class= "mb-5 ">
  <nav class="navbar navbar-expand-lg navbar-light mb-5 bg-success fixed-top">
            <div class="container">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link left-space" href="home.php">Home</a>
                  </li>
                </ul>
...
<br>
  <div class="beadonor">
    <h3 class="centre">ADMIN PANEL LOGIN</h3>
  </div>
        ...
        <div class="panel panel-default" style="padding: 20px;">
          ...
          <form action="" method="post" class="form-group form-container">
            ...
            <div class="form-group form">
              <button class="btn  btn-success center-aligned" style="margin-top:5px ;" type="submit" name="LogIn">Log In</button>
            </div>
